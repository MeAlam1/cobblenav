...
class OpenedRadialMenu(os: PokenavOS, statefulWidget: RadialPopupMenu, pX: Int, pY: Int) : RadialMenuState(os, statefulWidget, pX, pY, DIAMETER, DIAMETER, Component.literal("Opened Radial Menu")) {
	companion object {
