...
abstract class StatefulWidget(val parentScreen: Screen? = null, x: Int, y: Int, width: Int, height: Int, component: Component) : SoundlessWidget(x, y, width, height, component) {
