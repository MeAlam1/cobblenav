...
class BlockConditionWidget(val blockConditions: BlockConditions, x: Int, y: Int, width: Int, val horizontalGap: Int, val verticalGap: Int) : SoundlessWidget(x, y, width, 0, Component.literal("Block Conditions")) {
	companion object {
