...
interface ModDependant {
	...
	fun isModDependencySatisfied(): Boolean = if (neededInstalledMods.isNotEmpty() && neededInstalledMods.any {
			!Cobblenav.implementation.isModInstalled(it)
		}
	) {
		false
...
data class ModDependency(val id: String, val version: String)
